                ...
                <div className="body-container">
                    <div className='text-container'>
                        ...
                        <div className='personal-paragraph-container'>
                            ...
                            <p className='about-body'>
                                I'm an avid sports fan and love to see live music with my fiancé, Ellie. We also enjoy traveling and sampling the best food and drink from around the region. I'm a regular at music festivals all over the United States and you can always find me at my local disc golf course in my free time. When I am not out and about I enjoy curling up on the couch to watch a good movie with my fluffy, black, rescue cat named Artemis. As of late, I have taken an interest in cryptocurrency, blockchain technologies and their numerous possible use cases in the future.
                            </p>
                        </div>
                    </div>
                </div>
